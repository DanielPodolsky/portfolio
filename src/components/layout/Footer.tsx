...
export function Footer() {
  return (
    <footer className="mt-10 border-t border-neutral-900 pt-6 text-[11px] text-neutral-500">
      <div className="flex flex-col items-start justify-between gap-3 pb-4 sm:flex-row sm:items-center">
        <p>
          © {new Date().getFullYear()}{" "}
          <span className="font-medium text-neutral-300">Daniel Podolsky</span>.
        ...
        <div className="flex flex-wrap items-center gap-3 text-neutral-400">
          ...
          <span className="hidden sm:inline h-3 w-px bg-neutral-800" />
          <span className="inline-flex items-center">
